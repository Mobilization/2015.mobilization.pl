   	  ...
   	  talks: {
          ...
          "talk-unit-testy-w-androidzie-z-uzyciem-biblioteki-spock": {
			...
			"talk-xamarin-dla-nie-tylko-deweloperow-androida": {
			  ...
			  "description_html": "W ramach moich przygotowań do warsztatu o Xamarinie na codepot.pl 2015 powstała prezentacja o tym czym właściwie ta platforma jest. Często, mylnie, mówi się że Xamarin to kolejna hybrydowa technologia, zupełnie jak, fuj, cordova.W ramach prezentacji dowiemy się:<ul><li>co to właściwie jest Xamarin<li>czy to druga, równie kiepska, technologia co Cordova<li>co właściwie jest natywne (platform-specific) a co można współdzielić między projektami<li>jakie natywne komponenty są dostępne (UIKit dla iOS, RecycleView czy Support Library dla Androida)<li>czy to jest wreszcie to rozwiąznie gdzie piszemy raz a działa wszędzieBędę szczęśliwy jeśli w czasie prezentacji iOS-owcy pomyślą sobie \"o fajnie, normalnie mam tam UIKit i moge nawet pisać kawałki w Objective-C\", a Androidowcy westchną \"o super, jest wspierana najnowsza wersja Support Library, już tydzień po wydaniu\".",
			  "speakers_keys": [
				"speaker-aleksander-piotrowski"
			  ],
			  "language": "PL"
			...
			"talk-potrzeby-biznesowe-a-technologia-w-mobdev-na-przykladzie-seqr": {
			  ...
			  "description_html": "Specjaliści z dziedziny rozwoju produktu, użyteczności i technologii opowiedzą:<ul><li>W jaki sposób warto planować rozwój ekosystemu usług płatniczych w sytuacji, gdy potrzeba jak najszybciej adaptować się do zmieniającego się rynku, potrzeb użytkowników i działań konkurencji.<li>Jak skalujemy SCRUM by dobrze koordynować pracę wielu zespołów.<li>Dlaczego stawiamy na jak najszybsze zmiany (i ewentualne niepowodzenia) i jak się to nam udaje.<li>Dotychczasowa implementacja Lean Startup - doświadczone pętle zwrotne między strategią biznesową, UX, a zastosowaną technologią.<li>Dlaczego User Experience jest tak ważny - jaką wartość biznesową daje w przypadku SEQR.</ul>",
			  "speakers_keys": [
				"speaker-daniel-rurarz",
				"speaker-lukasz-szadkowski"
			  ],
